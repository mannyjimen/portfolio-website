...
{/* HEADER SECTION */}
        <div className="header-style">
          <ul>
            <li><a className = "top-page-link" href="https://www.linkedin.com/in/manueljimenez03/" target="_blank">linkedin</a></li>
            <li><a className = "top-page-link" href="https://github.com/mannyjimen" target="_blank">github</a></li>
          </ul>
          <p>
